...
training_data = []
test_data = []
training_data.append(SampledDataSet(load_160406, 1))
test_data.append(SampledDataSet(load_160406, 2))
...
n_time_steps=5
n_features=24
reframed_train = series_to_supervised(training_data.scaled_features,n_in=n_time_steps,n_out=1)
print('reframed')
