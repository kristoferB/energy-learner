...
%% 
rawData = importdata('160428- E - R10_orig.csv');
I = rawData.data(:,2);
V = rawData.data(:,3);
power = V.*I; %Watts
...
%% Energy and power, without cabinet but with regeneration
...
save('eOrig_R10.mat','total_energy','energy_noCabinet','consumedE','regenE','cycleTime','peakPower','filt_power');
